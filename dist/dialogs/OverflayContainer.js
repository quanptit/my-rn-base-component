...
export default class OverflayContainer extends ComponentNoUpdate {
    ...
    _renderOverComponent() {
        ...
        return (<TouchableHighlight underlayColor="transparent" style={{ position: 'absolute', left: 0, right: 0, bottom: 0, top: 0 }} onPressIn={() => { this.hideOverflayComponent(); }}>
    ...
    _renderPopup() {
        ...
        return (<TouchableHighlight underlayColor="transparent" style={{ position: 'absolute', left: 0, right: 0, bottom: 0, top: 0 }} onPressIn={() => { this.hidePopupMenu(); }}>
                <View style={style}>

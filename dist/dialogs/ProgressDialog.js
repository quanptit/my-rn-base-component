...
export default class ProgressDialog extends Component {
    ...
    render() {
        return (<PopupDialog dismissOnTouchOutside={this.props.cancelable} width={"85%"} show={true} ref={(popupDialog) => { this.popupDialog = popupDialog; }} dialogStyle={{ backgroundColor: "transparent" }}>
